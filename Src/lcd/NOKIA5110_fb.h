...
void desenha_fig_apagar(struct  pontos_t *p, const struct figura_t *figura);
void move_fig_dir(struct  pontos_t *p, const struct figura_t *figura, uint8_t pixels_mover);
int move_fig_esq(struct  pontos_t *p, const struct figura_t *figura, int pixels_mover);
void move_fig_cima(struct  pontos_t *p, const struct figura_t *figura, uint8_t pixels_mover);
void move_fig_baixo(struct  pontos_t *p, const struct figura_t *figura, uint8_t pixels_mover);
